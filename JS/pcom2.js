...
// Commented 2009 doesn't have all the discounts	if(a == 3 && (isCompDinnerDance(objForm.classYear) || is2000(objForm.classYear) ||isBelow1957(objForm.classYear) )) 
				...
				switch(a) 
				{
					...
					case 0:
						...
						intFFBSubtotal = fixInt(objForm.FFBQuantity) * intCost;
						objForm.FFBTotal.value = intFFBSubtotal;
					  if (isCompDinnerDance(objForm.classYear))
						{ 
          		intFFBSubtotal -= intMaxDiscount * intCost; // Class of 1963	
              ...
              document.getElementById("message").innerHTML = '2 Complimentary Tickets for Class of 1963';
				...
				//		objForm.FFBTotal.value = fixInt(objForm.FFBQuantity[a]) * fixInt(objForm.ItemCost[a]);
